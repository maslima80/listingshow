...
const updatePropertySchema = z.object({
  ...
  hoaDues: z.string().optional(),
  hoaPeriod: z.string().optional(),
...
export async function PUT(
  ...
  try {
    ...
    const propertyData = {
      ...
      yearBuilt: formData.get("yearBuilt") as string || undefined,
      hoaDues: formData.get("hoaDues") as string || undefined,
      hoaPeriod: formData.get("hoaPeriod") as string || undefined,
    ...
    await db
      ...
      .set({
        ...
        yearBuilt: validated.yearBuilt ? parseInt(validated.yearBuilt) : null,
        hoaDues: validated.hoaDues ? validated.hoaDues.replace(/[^0-9.]/g, '') : null,
        hoaPeriod: validated.hoaPeriod || null,
